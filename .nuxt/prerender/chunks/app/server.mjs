...
import { $fetch } from 'file://C:/Users/Nick/Desktop/PersonalWebsite/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file://C:/Users/Nick/Desktop/PersonalWebsite/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file://C:/Users/Nick/Desktop/PersonalWebsite/node_modules/unctx/dist/index.mjs';
import { getActiveHead } from 'file://C:/Users/Nick/Desktop/PersonalWebsite/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/Nick/Desktop/PersonalWebsite/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/Nick/Desktop/PersonalWebsite/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file://C:/Users/Nick/Desktop/PersonalWebsite/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL } from 'file://C:/Users/Nick/Desktop/PersonalWebsite/node_modules/ufo/dist/index.mjs';
import { defu } from 'file://C:/Users/Nick/Desktop/PersonalWebsite/node_modules/defu/dist/defu.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/Users/Nick/Desktop/PersonalWebsite/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-c95f0b7e.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-07022be7.mjs').then((m) => m.default || m)
  },
  {
    name: "projects-title",
    path: "/projects/:title()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_title_-3c48b961.mjs').then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-a2da8d7d.mjs').then((m) => m.default || m)
  },
  {
    name: "skills",
    path: "/skills",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/skills-f2c92616.mjs').then((m) => m.default || m)
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./_nuxt/ContentDoc-5097274e.mjs').then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import('./_nuxt/ContentList-5211b0e0.mjs').then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./_nuxt/ContentNavigation-b85d34b4.mjs').then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import('./_nuxt/ContentQuery-96affa01.mjs').then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./_nuxt/ContentRenderer-cd5aa57d.mjs').then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./_nuxt/ContentRendererMarkdown-31990daa.mjs').then((r) => r.default));
...
const LazyProseA = defineAsyncComponent(() => import('./_nuxt/ProseA-60283aad.mjs').then((r) => r.default));
...
const LazyProseH1 = defineAsyncComponent(() => import('./_nuxt/ProseH1-052e92eb.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./_nuxt/ProseH2-0a24b25b.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./_nuxt/ProseH3-bed8b8ef.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./_nuxt/ProseH4-c0a36357.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./_nuxt/ProseH5-46598d69.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./_nuxt/ProseH6-d6669dc5.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./_nuxt/ProseHr-91b5ad99.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./_nuxt/ProseImg-34db06d8.mjs').then((r) => r.default));
...
const layouts = {
  default: () => import('./_nuxt/default-808ad923.mjs').then((m) => m.default || m),
  home: () => import('./_nuxt/home-775d15b1.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-21c831d7.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRuntimeConfig as a, useNuxtApp as b, createError as c, asyncDataDefaults as d, entry$1 as default, useRouter as e, navigateTo as f, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRoute as u };
