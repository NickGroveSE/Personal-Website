import { u as useAsyncData } from './asyncData-91c49cf4.mjs';
...
import { defineComponent, toRefs, computed, useSlots, useSSRContext, toRef, isRef, h } from 'file://C:/Users/Nick/Desktop/PersonalWebsite/node_modules/vue/index.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-fded2491.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-bfb4bfd1.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-b85d34b4.mjs.map
